...
namespace Candlestick.Utils
{
    public static class Logger
    {
        private const string SdkTag = "CandlestickSDK";
        public const string KeyVerboseLoggingEnabled = "com.candlestick.verbose_logging_enabled";
